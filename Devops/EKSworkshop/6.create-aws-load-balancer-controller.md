...
### add subnet tags
```
subnets=$(aws ec2 describe-subnets  --filters Name=tag:Name,Values="eksctl-eks-test-cluster/SubnetPublicUSEAST1A","eksctl-eks-test-cluster/SubnetPublicUSEAST1B","eksctl-eks-test-cluster/SubnetPublicUSEAST1C" --region $AWS_REGION --query "Subnets[*].{SubnetId:SubnetId}" --o text)
...
alb-ingress   *       xxx.us-east-1.elb.amazonaws.com   80      13m
```
in browser, input below:
```
http://xxx.us-east-1.elb.amazonaws.com
```
