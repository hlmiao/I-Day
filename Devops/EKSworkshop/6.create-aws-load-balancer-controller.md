...
### add subnet tags
```
subnets=$(aws ec2 describe-subnets  --filters Name=tag:Name,Values="eksctl-eks-test-cluster/SubnetPublicUSEAST1A","eksctl-eks-test-cluster/SubnetPublicUSEAST1B" --region $AWS_REGION --query "Subnets[*].{SubnetId:SubnetId}" --o text)
